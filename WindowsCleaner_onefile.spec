# PyInstaller spec for Windows Cleaner (single-file exe).
# Run: pyinstaller WindowsCleaner_onefile.spec
# Or: python packaging/build_exe.py --onefile
# Output: dist/WindowsCleaner.exe (single file, ~50-80MB)
